...
@section('contents')
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="category_id" class="form-control" placeholder="Kategori" value="{{ $product->category->name }}" readonly>
            <!-- Pastikan $category->name sesuai dengan struktur relasi di model Product -->
        </div>
        <div class="col mb-3">
