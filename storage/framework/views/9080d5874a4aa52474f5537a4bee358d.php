...
<?php $__env->startSection('title', 'Dashboard  Z-STOK'); ?>
          ...
          <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                ...
                <div class="col-4"> 
                    <i class="fas <?php echo e($item['icon']); ?> fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mozart\Desktop\UAS Pemograman WEB\toko-lancar\resources\views/dashboard.blade.php ENDPATH**/ ?>